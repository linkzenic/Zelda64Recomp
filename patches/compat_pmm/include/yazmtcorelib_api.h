...
typedef DynamicU32Array YAZMTCore_DynamicU32Array;
typedef DynamicDataArray YAZMTCore_DynamicDataArray;
typedef IterableU32Set YAZMTCore_IterableU32Set;
typedef StringU32Dictionary YAZMTCore_StringU32Dictionary;
#else
