...
#define PMM_DL_SWORD4_BLADE_BROKEN PMM_DL_SWORD4_BLADE
#define PMM_DL_SWORD4_BLADE_FRAGMENT PMM_DL_SWORD4_BLADE
#define PMM_DL_ELEGY_OF_EMPTINESS_SHELL_HUMAN PMM_DL_ELEGY_OF_EMPTINESS_SHELL
#define PMM_DL_ELEGY_OF_EMPTINESS_SHELL_DEKU PMM_DL_ELEGY_OF_EMPTINESS_SHELL
#define PMM_DL_ELEGY_OF_EMPTINESS_SHELL_GORON PMM_DL_ELEGY_OF_EMPTINESS_SHELL
#define PMM_DL_ELEGY_OF_EMPTINESS_SHELL_ZORA PMM_DL_ELEGY_OF_EMPTINESS_SHELL
#define PMM_DL_ELEGY_OF_EMPTINESS_SHELL_FIERCE_DEITY PMM_DL_ELEGY_OF_EMPTINESS_SHELL
